...
- **Extended color grading fields**: Added 8 new clip fields — `exposure`, `black_point`, `highlights_warmth`, `highlights_tint`, `midtones_warmth`, `midtones_tint`, `shadows_warmth`, `shadows_tint` — with Inspector sliders and MCP `set_clip_color` support.
